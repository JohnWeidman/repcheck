...
def details(request, pk):
    ...
    processed_wiki = member_details.wikipedia.replace(" ", "_") if member_details.wikipedia else None
    ...
    member_details.wikipedia_url = f"https://en.wikipedia.org/wiki/{processed_wiki}" if member_details.wikipedia else None
    context = {"member_details": member_details, "member": member, "current": current}
